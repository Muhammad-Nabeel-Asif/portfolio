  ...
  return (
    <div className="bg-zinc-950 rounded-2xl border border-zinc-900 shadow-xl p-4 sm:p-6">
      <div className="border-b border-zinc-900 pb-5 mb-8">
        ...
        <p className="text-xs text-zinc-400 font-sans mt-0.5">Submit immediate job specs or coordination requests directly to Nabeel's delivery logs.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        ...
        <div className="lg:col-span-4 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-zinc-900 pb-6 lg:pb-0 lg:pr-8">
          <div className="space-y-6">
            <h3 className="text-xs font-bold text-white tracking-tight uppercase font-mono">Channel Registry</h3>
            ...
            <div className="space-y-4">
              <a
                ...
                className="flex items-center space-x-3.5 p-3 rounded-xl border border-zinc-900 bg-zinc-900/10 hover:bg-zinc-900/30 transition-all text-zinc-300"
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <span className="block text-3xs font-mono mt-1 text-white truncate">{PERSONAL_INFO.email}</span>
                </div>
              </a>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <span className="block text-3xs font-mono mt-1 text-white truncate">muhammad-nabeel-asif</span>
                </div>
              </a>

              <div className="flex items-center space-x-3.5 p-3 rounded-xl border border-zinc-900 bg-zinc-905/10 text-zinc-300">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <span className="block text-3xs font-sans mt-1 text-zinc-350 truncate">{PERSONAL_INFO.location}</span>
                </div>
              </div>
            </div>
          </div>

          <div className="mt-8 pt-6 border-t border-zinc-900/60 text-4xs font-mono text-zinc-500 flex items-center gap-1.5 leading-snug">
        ...
        <form onSubmit={handleSubmit} className="lg:col-span-8 flex flex-col justify-between space-y-4" aria-label="Recruiter Contact Form">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                className="w-full rounded-lg bg-zinc-905 border border-zinc-805 py-2 px-3 text-xs text-white placeholder-zinc-650 focus:outline-none focus:border-emerald-500 font-sans transition-all"
              />
            </div>
            ...
            <div className="flex flex-col">
              ...
              <select
                ...
                className="w-full rounded-lg bg-zinc-905 border border-zinc-805 py-2 px-3 text-xs text-white focus:outline-none focus:border-emerald-500 font-sans transition-all"
              >
          ...
          <div className="flex flex-col">
            ...
            <textarea
              ...
              className="w-full rounded-lg bg-zinc-905 border border-zinc-805 py-2 px-3 text-xs text-white placeholder-zinc-650 focus:outline-none focus:border-emerald-500 font-sans transition-all resize-none leading-relaxed"
            />
          </div>
          ...
          <div className="pt-2 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="min-h-[22px]">
              {submitSuccess && (
                <div className="flex items-center space-x-2 text-3xs font-mono text-emerald-400">
            ...
            <button
              ...
              className="cursor-pointer inline-flex items-center space-x-2.5 bg-emerald-500 hover:bg-emerald-400 disabled:bg-zinc-850 disabled:text-zinc-500 disabled:cursor-not-allowed justify-center text-xs font-semibold text-black px-6 py-2.5 rounded-lg transition-all active:scale-[0.98] self-end"
            >
